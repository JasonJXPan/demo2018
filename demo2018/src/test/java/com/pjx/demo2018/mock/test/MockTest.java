...
//        String sessionTime = "2019-12-06 11:00";
//        String occupyTimeStart = "2019-12-06 00:00";
//        String depositTimeEnd = "2019-12-06 08:30";
//        String pickUpTimeStart = "2019-12-06 09:00";
//        String occupyTimeEnd = "2019-12-06 23:59";

        List<OpenCabinetBookParam> bookParams = new ArrayList<>();
        String occupyStartTime = "2019-12-07 00:00:00";
        String occupyEndTime = "2019-12-07 23:59:59";

        String pickUpstartTime = "2019-12-07 09:00:00";
        String pickUpEndTime = occupyEndTime;

        String deliverStartTime = occupyStartTime;
        String deliverEndTime = "2019-12-07 08:30:00";

        OpenCabinetBookParam bookParam = new OpenCabinetBookParam();
        bookParam.setVenueId("1105venueId2");
        ...
        bookParam.setSessionId("1105showSessionId2");
        ...
        bookParam1.setVenueId("1105venueId2");
        ...
        bookParam1.setSessionId("1105showSessionId2");
...
//        bookParams.add(bookParam5);
    ...
    public void testCreateRule() {
        ...
        operateParam.setShowId("1105showId1");
        operateParam.setExcludeShowSessionIds(Arrays.asList("1105showSessionId3"));
        try {
            CabinetRuleOperateDetailParam detailParam = new CabinetRuleOperateDetailParam();
            detailParam.setBizCode("MTL");
            detailParam.setShowSessionId("1105showSessionId1");
            detailParam.setSessionTime(DateUtils.parseNoSecondFormat(sessionTime));
            detailParam.setVenueId("1105venueId1");
            ...
            detailParam.setSellerIds(Arrays.asList("1105sellerId1", "1105sellerId2", "1105sellerId3"));


            String sessionTime1 = "2019-12-07 11:00";
            String occupyTimeStart1 = "2019-12-07 00:00";
            String depositTimeEnd1 = "2019-12-07 08:30";
            String pickUpTimeStart1 = "2019-12-07 09:00";
            String occupyTimeEnd1 = "2019-12-07 23:59";
            CabinetRuleOperateDetailParam detailParam1 = new CabinetRuleOperateDetailParam();
            detailParam1.setBizCode("MTL");
            detailParam1.setShowSessionId("1105showSessionId2");
            detailParam1.setSessionTime(DateUtils.parseNoSecondFormat(sessionTime1));
            detailParam1.setVenueId("1105venueId2");
            ...
            detailParam1.setSellerIds(Arrays.asList("1105sellerId2", "1105sellerId3"));
...
//        String occupyTimeEnd1 = "2019-12-07 23:59";
        String sessionTime = "2019-12-06 11:00";
        String occupyTimeStart = "2019-12-05 00:00";
        String depositTimeEnd = "2019-12-06 09:30";
        String pickUpTimeStart = "2019-12-06 10:00";
        String occupyTimeEnd = "2019-12-08 23:59";
        CabinetRuleOperateParam operateParam = new CabinetRuleOperateParam();
        operateParam.setBizCode("MTL");
        operateParam.setShowId("showId");
        operateParam.setExcludeShowSessionIds(Arrays.asList("1105showSessionId2"));
//        excludeShowSessionIds
    ...
    public void testGetSellerIds() {
        ...
        boolean result =list1.addAll(null);
